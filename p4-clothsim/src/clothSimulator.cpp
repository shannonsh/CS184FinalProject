...
void ClothSimulator::load_textures() {
  ...
  m_gl_texture_4_size = load_texture(4, m_gl_texture_4, (m_project_root + "/textures/texture_4.png").c_str());
    m_gl_texture_5_size = load_texture(5, m_gl_texture_5, (m_project_root + "/textures/texture_5.png").c_str());
    m_gl_texture_6_size = load_texture(6, m_gl_texture_6, (m_project_root + "/textures/texture_6.png").c_str());
